...
typedef NS_ENUM(NSUInteger, PNSBuildModelStyle) {
    ...
    //二次授权页
    PNSBuildModelStylePrivacyAlertPortraitAlert,
    PNSBuildModelStylePrivacyAlertPortraitActionSheet,
    PNSBuildModelStylePrivacyAlertLandscapeAlert,
    PNSBuildModelStylePrivacyAlertLandscapeActionSheet,
    PNSBuildModelStyleAlertPrivacyAlert,
